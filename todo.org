...
/Users/craig/Documents/projects/deno_shell › console.log(this); | less
Couldn't find command "console.log(this);"
...
* TODO Move cursor to the end of the line when pasting
* TODO Try to sandbox eval's
